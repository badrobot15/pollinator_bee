...
class DroneFly():
	...
	def __init__(self):
		...
		rospy.Subscriber('/pid_tuning', PidTune, self.set_pid_val)
	...
	def set_pid_val(self,pid_val):

		#This is the subscriber function to get the Kp, Ki and Kd values set through the GUI

		self.kp_roll = pid_val.Kp_x
		self.kp_pitch = pid_val.Kp_y
		self.kp_throt = pid_val.Kp_z

		self.ki_roll = pid_val.Ki_x
		self.ki_pitch = pid_val.Ki_y
		self.ki_throt = pid_val.Ki_z

		self.kd_roll = pid_val.Kd_x
		self.kd_pitch = pid_val.Kd_y
		self.kd_throt = pid_val.Kd_z
